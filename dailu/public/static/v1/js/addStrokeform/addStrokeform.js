...
$(function () {
    ...
    $(".select_clas_box").each(function (i, n) {
        $(n).on("click", function () {
            ...
            if(i == 0){
                $(n).siblings().find(".form_icon").removeClass("tra_active1 tra_active2");
            }else if(i == 1){
                $(n).siblings().find(".form_icon").removeClass("tra_active0 tra_active2");
            }else {
                $(n).siblings().find(".form_icon").removeClass("tra_active0 tra_active1");
            }
        });
        // 
    });
