 ...
 $.fn.kuiDate = function(k_date){
	...
	function kui_date(){ //var d = new Date().getTime();
		...
		// $('#kui_d_pane').attr('style','left:'+0+'px; top:'+ 0 +'px;');
		$('.doubledate').on("focus",function(){
		...
		$('a.kui_prev_m').click(function(){
			...
			change_date('left');
			change_date('right');
			//点击上一页 后更新当前日期为今天 给每个日期绑定点击 让input输入框触发change 事件
			$('.kui_td_hui:last').next('.kui_not_kong ').html('今天').on('click',function(){
				$('.doubledate').val(today);
			})

			$('.kui_not_kong').on('click',function(){
			$('.doubledate').change();
			console.log(123)
			})
		});
		$('a.kui_next_m').click(function(){
			...
			change_date('left');
			change_date('right');
			//点击下一页 后更新当前日期为今天 给每个日期绑定点击 让input输入框触发change 事件
			$('.kui_td_hui:last').next('.kui_not_kong ').html('今天').on('click',function(){
				$('.doubledate').val(today);
			})
...
// 点击文档的其它地方让日期插件关闭
$(function(){
	$('.kui_d_pane').on("click",function(e){
...
$(function(){
	/* 日期插件的HTML元素 */
	var kui_div_date = '<div class="kui_d_pane" id="kui_d_pane" style="display:none;"><iframe id="kui_frame_d" width="480" height="0" frameborder="0"></iframe></iframe><div class="kui_data_content_pane"><div class="kui_prev_next_month"><a href="javascript:;" class="kui_prev_m" id="kui_prev_m">&lt;</a><span class="kui_today"></span><a href="javascript:;" class="kui_next_m" id="kui_next_m" >&gt;</a><span class="kui_tomorrow"></span></div><div id="left_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_left_t"></dl></div><div id="right_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_right_t"></dl></div><div class="kui_date_reset"><span class="off">清空</span><span class="close">关闭</span></div></div></div>';
	$('#doubledate').append(kui_div_date);
