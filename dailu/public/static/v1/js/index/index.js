...
function get_hot_mall_top(){
    var get_offset= $('.service_icon').offset();
    // console.log(get_offset)
    $('.hot_mall_box').offset({
        top:get_offset.top,
        left:get_offset.left-280
    }).show()
}
get_hot_mall_top()
...
$(function () {
    ...
    $.post("/portal/index/hot_planData",function(data){
        ...
        var hot_planTem1 = '{{each tourList as value i}}\
                            {{if i <= 3 }}\
                                <div class="item ani" swiper-animate-effect="fadeInUpx" swiper-animate-duration="0.8s" swiper-animate-delay="0s"><a href="/portal/itinerary/tripInfo/{{value.trip_id}}.html">\
                                    <div class="item_cont">\
                                        <div class="img_box">\
                                    ...
                                    {{if value.theme == 1}}\
                                        <div class="cj_icon"><img src="/static/v1/img/index/CJ.png"></div>\
                                    {{/if}}\
                                </a></div>\
                            {{/if}}\
                            {{/each}}';
