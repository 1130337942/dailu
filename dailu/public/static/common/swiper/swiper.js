...
var Keyboard = {
  handle: function handle(event) {
    ...
    // Directions locks
    if (!swiper.allowSlideNext && ((swiper.isHorizontal() && kc === 39) || (swiper.isVertical() && kc === 40) || (swiper.isVertical() && kc === 34))) {
      return false;
    }
    if (!swiper.allowSlidePrev && ((swiper.isHorizontal() && kc === 37) || (swiper.isVertical() && kc === 38) || (swiper.isVertical() && kc === 33))) {
      return false;
    }
    ...
    if (swiper.params.keyboard.onlyInViewport && (kc === 37 || kc === 39 || kc === 38 || kc === 40 || kc === 33 || kc === 34)) {
      var inView = false;
    ...
    if (swiper.isHorizontal()) {
      ...
      if (kc === 40 || kc === 34) { swiper.slideNext(); }
      if (kc === 38 || kc === 33) { swiper.slidePrev(); }
    }
