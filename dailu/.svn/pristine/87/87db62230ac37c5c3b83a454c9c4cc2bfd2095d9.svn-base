                    ...
                    for (var i = 0; i < mouseup_daynum_array.length; i++) {
                        ...
                        if (mouseup_lng_next != undefined) {
                            ...
                            function allattr($n, type) {
                                if (type == "list") {
                                    $n.attr("data-flt", air_time).end()
                                        .attr("data-trt", train_time).end()
                                        .attr("data-othert", other_time);
                                } else if (type == "start") {
                                    $n.attr("data-flt", start_air_time).end()
                                        .attr("data-trt", start_train_time).end()
                                        .attr("data-othert", start_other_time);
                                } else {
                                    $n.attr("data-flt", return_air_time).end()
                                        .attr("data-trt", return_train_time).end()
                                            ...
                                            <div class="list_traffic">\
                                                {{if traffic_tools == "飞机交通"}}\
                                                    ...
                                                    {{else if value.flightTime == "" && value.trainTime == ""}}\
                                                        <i class="traffic_icon other_icon"></i><span class="list_trc_name">汽车交通</span>·<span class="js_list_dis">{{value.dis}}</span>公里·<span class="trcTime">{{value.trafficTime}}</span>小时\
                                                    {{else}}\
                                                ...
                                                {{else}}\
                                                    ...
                                                    {{/if}}\
                                                {{/if}}\
                                                <i class="traffic_icon_r" data-flt = "{{value.flightTime}}" data-trt = "{{value.trainTime}}" data-othert={{value.trafficTime}} ></i>\
                                            </div>\
                                    ...
                                    <div class="return_traffic">\
                                        {{if traffic_tools == "飞机交通"}}\
                                            ...
                                            {{else if return_traffic.flightTime == "" && return_traffic.trainTime == ""}}\
                                                <i class="traffic_icon other_icon"></i><span class="list_trc_name">汽车交通</span>·<span class="js_return_dis">{{return_traffic.dis}}</span>公里·<span class="trcTime">{{return_traffic.trafficTime}}</span>小时\
                                            {{else}}\
                                        ...
                                        {{else}}\
                                            ...
                                            {{/if}}\
                                        {{/if}}\
                                        <i class="traffic_icon_r return_traffic_icon_r" data-flt = "{{return_traffic.flightTime}}" data-trt = "{{return_traffic.trainTime}}" data-othert={{return_traffic.trafficTime}} ></i>\
                                    </div>';
        ...
        tratoolsFn: function () {
            ...
            function trafficMore(city_index, n) {
                ...
                if (city_index == -1) {
                    ...
                    if (tra_name == "飞机交通") {
                        $(".return_traffic").find(".traffic_icon").addClass("air_icon").removeClass("tra_icon other_icon");
                    } else if (tra_name == "汽车交通") {
                        $(".return_traffic").find(".traffic_icon").addClass("other_icon").removeClass("tra_icon air_icon");
                    } else {
                        $(".return_traffic").find(".traffic_icon").addClass("tra_icon").removeClass("air_icon other_icon");
                    }
                } else {
        ...
        nextFn: function (form_data) {
            ...
            $(".next").on("click", function () {
                ...
                $("#city_list .list").each(function (i, n) {
                    ...
                    tra_go_city_obj.trafficTime = list_go_city.find(".traffic_icon_r").attr("data-othert") //汽车交通时间
