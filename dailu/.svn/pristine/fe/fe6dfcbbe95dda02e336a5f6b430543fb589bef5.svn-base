...
$(function () {
    ...
    initObj = {
        ...
        trcDisFn: function (dis, index, is_del) {
            ...
            if (typeof index == "number") {
                ...
                go_city_Arr[index].trc_time = initObj.TrctimeFn(trc_time);
            ...
            if (index == 'first' || is_del == "del") {
                ...
                firstTrc.trc_time = initObj.TrctimeFn(trc_time);
                return firstTrc
            };
    ...
    var templateObj = {
        ...
        addcity_template: function (obj_addciy) {
            ...
            //                     <span class="trcTime">'+obj_addciy.trc_time+'</span>小时<i class="traffic_icon_r"></i>\
            //                 </div>\
            //                 <div class="list_city">\
            //                     <div class="city_list_l">\
            //                         <i class="delete_icon"></i>\
